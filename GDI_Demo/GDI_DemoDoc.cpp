...
// GDI_DemoDoc.cpp : implementation of the CGDIDemoDoc class
//
...
CGDIDemoDoc::CGDIDemoDoc() noexcept
{
...
void CGDIDemoDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CGDIDemoDoc::InitializeSearchContent()
{
...
void CGDIDemoDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
