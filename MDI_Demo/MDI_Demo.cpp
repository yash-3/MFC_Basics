...
// MDI_Demo.cpp : Defines the class behaviors for the application.
//
...
BEGIN_MESSAGE_MAP(CMDIDemoApp, CWinAppEx)
...
CMDIDemoApp::CMDIDemoApp() noexcept
{
...
// CMDIDemoApp customization load/save methods

void CMDIDemoApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CMDIDemoApp::LoadCustomState()
{
}

void CMDIDemoApp::SaveCustomState()
{
}
