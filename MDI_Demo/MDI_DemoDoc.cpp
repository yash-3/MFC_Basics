...
// MDI_DemoDoc.cpp : implementation of the CMDIDemoDoc class
//
...
CMDIDemoDoc::CMDIDemoDoc() noexcept
{
...
void CMDIDemoDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CMDIDemoDoc::InitializeSearchContent()
{
...
void CMDIDemoDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
