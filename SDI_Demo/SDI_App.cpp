...
BOOL CExerciseApp::InitInstance()
{
	...
	*/
	...
	pDocTemplate = new CSingleDocTemplate(IDR_MAINFRAME, RUNTIME_CLASS(CExerciseDoc),RUNTIME_CLASS(CMainFrame),	RUNTIME_CLASS(CExerciseView));
...
// used to create window with different size
BOOL CMainFrame::PreCreateWindow(CREATESTRUCT& cs)
{
	// cs.style &= ~(WS_MAXIMIZEBOX | WS_MINIMIZEBOX);
	cs.cx = 850; // Change the width
